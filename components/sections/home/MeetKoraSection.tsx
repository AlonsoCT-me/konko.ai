      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col items-start">
            ...
            <Link
              href="#demo"
              className="group mt-8 inline-flex items-center gap-2 text-sm font-semibold text-neutral-950 transition-colors hover:text-brand-gold"
            >
              {t("Try Kora")}
          ...
          <div className="flex justify-end">
            ...
            >
              ...
              <div className="absolute bottom-5 left-5 flex max-w-[260px] items-center gap-3 rounded-2xl border border-[rgba(255,255,255,0.6)] px-4 py-3 shadow-[0_4px_24px_rgba(0,0,0,0.08)] [backdrop-filter:blur(12px)] [background:rgba(255,255,255,0.55)]">
